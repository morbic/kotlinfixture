= KotlinFixture
Michal Browarski <michal@browarski.com>
:toc: preamble
:toc-title: Contents
:homepage: https://github.com/morbic/kotlinfixture
ifdef::env-github[]
:tip-caption: :bulb:
...
https://central.sonatype.com/search?q=g:com.browarski.kotlinfixture&smo=true[image:https://img.shields.io/maven-central/v/com.browarski.kotlinfixture/fixture[Maven Central]]
https://github.com/morbic/kotlinfixture/actions[image:https://github.com/morbic/kotlinfixture/workflows/CI/badge.svg[CI status]]
https://codecov.io/gh/morbic/kotlinfixture[image:https://codecov.io/gh/morbic/kotlinfixture/branch/main/graph/badge.svg[Coverage status]]
...
._build.gradle.kts_
----
testImplementation("com.browarski.kotlinfixture:fixture:<latest-version>")
----
