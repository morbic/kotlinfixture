...
class ComparisonParametizedTest {
    ...
    @ParameterizedTest
    @MethodSource("data")
    fun `morbic creates instance`(
        type: KType,
        morbicSupports: Result,
        flextradeSupports: Result,
        marcellogalhardoSupports: Result,
        easyRandomSupports: Result
    ) {
        assumeValid(morbicSupports)

        @Suppress("DEPRECATION_ERROR")
        val result = morbic.create(type, morbic.fixtureConfiguration)!!
    ...
    @ParameterizedTest
    @MethodSource("data")
    fun `morbic creates random instance`(
        type: KType,
        morbicSupports: Result,
        flextradeSupports: Result,
        marcellogalhardoSupports: Result,
        ...
        assumeRandom(morbicSupports)

        assertIsRandom {
            @Suppress("DEPRECATION_ERROR")
            morbic.create(type, morbic.fixtureConfiguration)!!
        }
    }
    ...
    companion object {
        ...
        private val morbic = kotlinFixture()
